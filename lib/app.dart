  ...
  Widget build(BuildContext context) {
    return GetBuilder<SettingsController>(
      ...
      builder: (settingsController) {
        // Settings henüz yüklenmemişse loading göster
        ...
        return GetMaterialApp(
          ...
          // Tema ayarları
          theme: AppTheme.lightTheme(settingsController.primaryColorIndex),
          darkTheme: AppTheme.darkTheme(settingsController.primaryColorIndex),
          themeMode: settingsController.isDarkMode ? ThemeMode.dark : ThemeMode.light,
      
          // Dil ve lokalizasyon
          locale: settingsController.language == 'en' 
              ? const Locale('en', 'US') 
              : const Locale('tr', 'TR'),
          ...
          builder: (context, child) {
            return MediaQuery(
              ...
              data: MediaQuery.of(context).copyWith(
                textScaler: const TextScaler.linear(1.0), // Sabit text boyutu
              ),
              child: child!,
            );
          },
...
class IzForceTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    ...
    'tr_TR': {
      ...
      'results': 'Sonuçlar',
      'settings': 'Ayarlar',
      'progress_dashboard': 'İlerleme Analizi',
      'analytics': 'Analitik',
      ...
      // Test türleri
      'cmj': 'Aktif Sıçrama',
      'squat_jump': 'Skuat Sıçrama',
      'drop_jump': 'Derinlik Sıçrama',
      'continuous_jump': 'Çoklu Sıçrama',
      'imtp': 'İzometrik Orta Uyluk Çekişi',
      'isometric_squat': 'İzometrik Skuat',
      'static_balance': 'Statik Denge',
      'dynamic_balance': 'Dinamik Denge',
      'single_leg_balance': 'Tek Ayak Denge',
      'lateral_hop': 'Yanal Sıçrama',
      'anterior_posterior_hop': 'Ön-Arka Sıçrama',
      'medial_lateral_hop': 'İç-Dış Sıçrama',
    ...
    'en_US': {
      ...
      'drop_jump': 'Drop Jump',
      'continuous_jump': 'Continuous Jump',
      'imtp': 'Isometric Mid-Thigh Pull',
      'isometric_squat': 'Isometric Squat',
      'static_balance': 'Static Balance',
      'dynamic_balance': 'Dynamic Balance',
      'single_leg_balance': 'Single Leg Balance',
      'lateral_hop': 'Lateral Hop',
      'anterior_posterior_hop': 'Anterior Posterior Hop',
      'medial_lateral_hop': 'Medial Lateral Hop',
...
class AppRoutes {
  ...
  static List<GetPage> get pages => [
    ...
    GetPage(
      ...
      page: () => ProgressDashboardScreen(
        athleteId: Get.parameters['athleteId'] ?? 'default',
      ),
      transition: Transition.rightToLeft,
    ),
    ...
    // AI Insights
    GetPage(
      name: '/ai-insights/:athleteId',
      page: () => AIInsightsScreen(
        athleteId: Get.parameters['athleteId'] ?? 'default',
      ),
      transition: Transition.rightToLeft,
    ),
