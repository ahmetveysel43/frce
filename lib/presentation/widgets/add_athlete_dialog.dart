...
class _AddAthleteDialogState extends State<AddAthleteDialog> {
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(8),
          borderSide: BorderSide(color: AppTheme.darkDivider),
        ),
  ...
  Widget _buildDatePicker() {
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Icon(Icons.cake, color: AppTheme.textSecondary),
            const SizedBox(width: 12),
            Expanded(
              child: Column(
  ...
  Widget _buildGenderDropdown() {
    return DropdownButtonFormField<Gender>(
      ...
      decoration: InputDecoration(
        labelText: 'Cinsiyet',
        labelStyle: TextStyle(color: AppTheme.textSecondary),
        prefixIcon: Icon(Icons.people_alt, color: AppTheme.textSecondary),
        filled: true,
        fillColor: AppTheme.darkBackground,
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(8),
  ...
  Widget _buildSportDropdown() {
    ...
    return DropdownButtonFormField<String>(
      ...
      decoration: InputDecoration(
        labelText: 'Spor Dalı',
        labelStyle: TextStyle(color: AppTheme.textSecondary),
        prefixIcon: Icon(Icons.sports, color: AppTheme.textSecondary),
        filled: true,
        fillColor: AppTheme.darkBackground,
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(8),
  ...
  void _selectDate() async {
    final date = await showDatePicker(
      context: context,
      initialDate: _dateOfBirth ?? DateTime.now().subtract(Duration(days: 365 * 20)),
  ...
  /// Show add athlete dialog
  static Future<Athlete?> show({Athlete? athlete}) async {
    return await Get.dialog<Athlete>(
