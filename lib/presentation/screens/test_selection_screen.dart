...
class TestSelectionScreen extends StatelessWidget {
 ...
 void _selectTest(TestType testType, TestController testController) {
  ...
  // DÜZELTME: Direk test-execution'a gitmek yerine step flow'u takip et
  // Mevcut step'i kontrol et ve uygun adıma ilerlet
  if (testController.currentStep == TestStep.testSelection) {
    // Test execution ekranına git ama step'i kalibrasyon yap
    Get.offNamed('/test-execution');
    // Step'i kalibrasyon'a getir
    testController.goToStep(TestStep.calibration);
  } else {
    // Eğer farklı bir step'teysek, test execution'a git
              ...
              child: ListView(
                children: [
                  _buildTestInfoCard(
                    ...
                    tests: ['CMJ - Aktif Sıçrama', 'SJ - Skuat Sıçrama', 'DJ - Derinlik Sıçrama', 'CJ - Çoklu Sıçrama'],
                  ),
                  const SizedBox(height: 16),
                  ...
                  _buildTestInfoCard(
                    ...
                    tests: ['IMTP - İzometrik Orta Uyluk Çekişi', 'IS - İzometrik Skuat'],
                  ),
                  const SizedBox(height: 16),
                  ...
                  _buildTestInfoCard(
                    ...
                    tests: ['SB - Statik Denge', 'DB - Dinamik Denge', 'SLB - Tek Ayak Denge'],
                  ),
                  const SizedBox(height: 16),
                  ...
                  _buildTestInfoCard(
                    ...
                    tests: ['LH - Yanal Sıçrama', 'APH - Ön-Arka Sıçrama', 'MLH - İç-Dış Sıçrama'],
                  ),
                ],
              ),
            ),
