...
class TestController extends GetxController {
  ...
  Future<void> _initializeController() async {
    try {
      ...
      AppLogger.error('TestController başlatma hatası', e, stackTrace);
  ...
  Future<bool> startCalibration() async {
    ...
    try {
      ...
      AppLogger.error('Kalibrasyon hatası', e, stackTrace);
  ...
  void _updateLiveMetrics() {
    ...
    _liveMetrics.value = {
      ...
      'currentForce': _forceData.last.totalGRF,
    };
  }
    ...
    try {
      ...
      final result = TestResult.create(
        ...
        metadata: {
          ...
          'leftZeroOffset': _leftZeroOffset.value,
          'rightZeroOffset': _rightZeroOffset.value,
        },
      );
      ...
      AppLogger.error('Test sonuç işleme hatası', e, stackTrace);
  ...
  Future<Map<String, double>> _calculateJumpMetrics(ForceDataCollection collection, double bodyWeight) async {
    ...
    return {
      ...
      'peakForceAboveBW': forceAboveBodyweight,
