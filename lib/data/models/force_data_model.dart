...
class ForceDataModel {
  ...
  final double? leftCOP_x; // Center of Pressure X - Sol (mm)
  
  @JsonKey(name: 'left_cop_y')
  final double? leftCOP_y; // Center of Pressure Y - Sol (mm)
  
  @JsonKey(name: 'right_cop_x')
  final double? rightCOP_x; // Center of Pressure X - Sağ (mm)
  
  @JsonKey(name: 'right_cop_y')
  final double? rightCOP_y; // Center of Pressure Y - Sağ (mm)
  ...
  final double? combinedCOP_x; // Combined COP X
  
  @JsonKey(name: 'combined_cop_y')
  final double? combinedCOP_y; // Combined COP Y
  ...
  factory ForceDataModel.fromMap(Map<String, dynamic> map) {
    return ForceDataModel(
      ...
      leftCOP_x: map['leftCOP_x'] as double?,
      leftCOP_y: map['leftCOP_y'] as double?,
      rightCOP_x: map['rightCOP_x'] as double?,
      rightCOP_y: map['rightCOP_y'] as double?,
      ...
      combinedCOP_x: map['combinedCOP_x'] as double?,
      combinedCOP_y: map['combinedCOP_y'] as double?,
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'leftCOP_x': leftCOP_x,
      'leftCOP_y': leftCOP_y,
      'rightCOP_x': rightCOP_x,
      'rightCOP_y': rightCOP_y,
      'loadCell1': loadCell1,
      'loadCell2': loadCell2,
      'loadCell3': loadCell3,
      'loadCell4': loadCell4,
      ...
      'combinedCOP_x': combinedCOP_x,
      'combinedCOP_y': combinedCOP_y,
      'isValid': isValid ? 1 : 0,
  ...
  factory ForceDataModel.fromEntity(ForceData entity, String sessionId) {
    return ForceDataModel(
      ...
      leftCOP_x: entity.leftCOP_x,
      leftCOP_y: entity.leftCOP_y,
      rightCOP_x: entity.rightCOP_x,
      rightCOP_y: entity.rightCOP_y,
      asymmetryIndex: entity.asymmetryIndex,
      combinedCOP_x: entity.combinedCOP?.x,
      combinedCOP_y: entity.combinedCOP?.y,
      isValid: true,
  ...
  factory ForceDataModel.fromLoadCells({
    ...
    return ForceDataModel(
      ...
      combinedCOP_x: combinedCOP?.x,
      combinedCOP_y: combinedCOP?.y,
  ...
  static ({double x, double y})? _calculateCombinedCOP(
    ...
    final leftCOP_global_x = leftCOP.x - platformGap/2;
    final leftCOP_global_y = leftCOP.y;
    
    // Sağ platform COP'u global koordinat sisteminde
    final rightCOP_global_x = rightCOP.x + platformGap/2;
    final rightCOP_global_y = rightCOP.y;

    // Weighted average
    final combinedX = (leftCOP_global_x * leftGRF + rightCOP_global_x * rightGRF) / totalForce;
    final combinedY = (leftCOP_global_y * leftGRF + rightCOP_global_y * rightGRF) / totalForce;
  ...
  ForceDataModel copyWith({
    ...
    double? combinedCOP_x,
    double? combinedCOP_y,
    bool? isValid,
    double? noiseLevel,
    ...
    return ForceDataModel(
      ...
      leftCOP_x: leftCOP_x ?? this.leftCOP_x,
      leftCOP_y: leftCOP_y ?? this.leftCOP_y,
      rightCOP_x: rightCOP_x ?? this.rightCOP_x,
      rightCOP_y: rightCOP_y ?? this.rightCOP_y,
      ...
      combinedCOP_x: combinedCOP_x ?? this.combinedCOP_x,
      combinedCOP_y: combinedCOP_y ?? this.combinedCOP_y,
