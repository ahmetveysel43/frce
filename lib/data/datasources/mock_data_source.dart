...
class MockDataSource {
  ...
  double _baselineNoise = 5.0; // Baseline noise in Newtons
  ...
  ForceData _generateStaticBalanceData(double timeSeconds) {
    ...
    return ForceData.create(
      ...
      leftCOP_x: swayX + _generateNoise(8),
      leftCOP_y: swayY + _generateNoise(10),
      rightCOP_x: -swayX + _generateNoise(8),
      rightCOP_y: swayY + _generateNoise(10),
    );
  }
  ...
  ForceData _generateDynamicBalanceData(double timeSeconds) {
    ...
    return ForceData.create(
      ...
      leftGRF: (baseForce * (0.5 + _asymmetryFactor / 2)) - _leftZeroOffset,
      rightGRF: (baseForce * (0.5 - _asymmetryFactor / 2)) - _rightZeroOffset,
      leftCOP_x: swayX + _generateNoise(15),
      leftCOP_y: swayY + _generateNoise(18),
      rightCOP_x: -swayX * 0.8 + _generateNoise(15),
      rightCOP_y: swayY * 0.9 + _generateNoise(18),
    );
  }
  ...
  ForceData _generateSingleLegBalanceData(double timeSeconds) {
    ...
    return ForceData.create(
      ...
      leftCOP_x: swayX + _generateNoise(20),
      leftCOP_y: swayY + _generateNoise(25),
      rightCOP_x: _generateNoise(30), // Minimal contact
      rightCOP_y: _generateNoise(30),
    );
  }
  ...
  ForceData _generateCalibrationData() {
    ...
    return ForceData.create(
      ...
      leftGRF: leftForce,
      rightGRF: rightForce,
      leftCOP_x: _generateNoise(5),
      leftCOP_y: _generateNoise(5),
      rightCOP_x: _generateNoise(5),
      rightCOP_y: _generateNoise(5),
    );
  }
  ...
  ForceData _createForceData(double totalForce, double timeSeconds) {
    ...
    return ForceData.create(
      ...
      leftCOP_x: copX + _generateNoise(10),
      leftCOP_y: copY + _generateNoise(12),
      rightCOP_x: -copX * 0.8 + _generateNoise(10),
      rightCOP_y: copY * 0.9 + _generateNoise(12),
    );
  }
  ...
  void updateParameters({
    ...
    if (baselineNoise != null) _baselineNoise = baselineNoise;
