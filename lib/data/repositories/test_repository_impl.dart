...
class AthleteRepositoryImpl implements AthleteRepository {
  ...
  Future<List<Athlete>> getAllAthletes() async {
    try {
      ...
      // Assuming MockDataSource has a method to get mock AthleteModels
      // If MockDataSource.getMockAthletes returns List<Athlete>, convert it to List<AthleteModel> first.
      // Or, if it directly provides AthleteModel, use it as is.
      // For now, assuming MockAthletes.sampleAthletes is List<Athlete>
