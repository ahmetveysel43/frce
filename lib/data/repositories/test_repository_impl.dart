  ...
  String? _getPrimaryMetricNameForTrend(TestType testType) {
    switch (testType) {
      ...
      case TestType.medialLateralHop:
        return 'speed';
    } // Updated switch statement for all test types
  }
  ...
  Future<TestComparison?> compareTests(String sessionId1, String sessionId2) async {
    try {
      ...
      if (test1 == null || test2 == null) {
        throw const TestDataNotFoundException('Karşılaştırma için testlerden biri bulunamadı.');
      }
      if (test1.testType != test2.testType) {
        throw const InvalidTestDataException('Farklı test türleri karşılaştırılamaz.');
      }
