...
class TestResult extends Equatable {
  ...
  factory TestResult.create({
    ...
    final finalTestDate = testDate ?? now;
    return TestResult(
      id: _generateId(),
      sessionId: sessionId,
      athleteId: athleteId,
  ...
  factory TestResult.fromMap(Map<String, dynamic> map) {
    return TestResult(
      ...
      testType: _getTestTypeEnum(map['testType'] as String),
      testDate: DateTime.parse(map['testDate'] as String),
      duration: Duration(milliseconds: map['duration'] as int),
      status: _getTestStatusEnum(map['status'] as String),
  ...
  static TestType _getTestTypeEnum(String testTypeStr) {
  ...
  static TestStatus _getTestStatusEnum(String statusStr) {
    try {
