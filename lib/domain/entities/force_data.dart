...
class ForceData extends Equatable {
  ...
  ({double x, double y})? get combinedCOP {
    if (leftCOP_x == null || leftCOP_y == null || 
        rightCOP_x == null || rightCOP_y == null) {
      return null;
    }
    ...
    final x = (leftCOP_x! * leftGRF + rightCOP_x! * rightGRF) / totalForce;
    final y = (leftCOP_y! * leftGRF + rightCOP_y! * rightGRF) / totalForce;
