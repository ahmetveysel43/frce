...
extension DoubleExtensions on double {
  ...
  String toForceString({bool showUnit = true}) {
    final formatted = this.toStringSmartFormat();
  ...
  double clampToRange(double min, double max) => this.clamp(min, max);
  ...
  /// Yukarı yuvarla (ceil)
  double get ceiling => this.ceilToDouble();
  
  /// Aşağı yuvarla (floor)
  double get floor => this.floorToDouble();
