...
class DatabaseProvider {
  ...
  Future<void> _onDowngrade(Database db, int oldVersion, int newVersion) async {
    ...
    throw Exception('Database downgrade desteklenmiyor'); // ✅ FIXED: DatabaseException -> Exception
  }

  /// Backup'dan database'i restore et (v2)
  Future<void> restoreBackup(String backupPath) async {
    try {
      ...
      if (!await backupFile.exists()) {
        throw Exception('Backup dosyası bulunamadı: $backupPath'); // ✅ FIXED: DatabaseException -> Exception
      }
