...
class PhaseDetector {
  ...
  static bool _isForceDecreasing(List<ForceData> history) {
    ...
    final recent = history.takeLast(3).toList();
    return recent[2].totalGRF < recent[1].totalGRF && recent[1].totalGRF < recent[0].totalGRF;
  }
  ...
  static bool _isForceStable(List<ForceData> history, double lowerBound, double upperBound) {
    ...
    final recent = history.takeLast(5).toList();
